...
export default function Button({
  ...
  const base = "inline-flex items-center justify-center rounded-sm text-sm font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-40";

  const variants = {
    primary: "bg-navy-800 text-white hover:bg-navy-900",
    outline: "border border-grey-200 text-grey-900 hover:border-navy-800 hover:text-navy-800",
    ghost:   "text-grey-900 hover:text-navy-800",
  };
