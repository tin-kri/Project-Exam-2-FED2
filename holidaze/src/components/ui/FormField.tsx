    ...
    <div className="flex flex-col gap-1">
      ...
      {multiline ? (
        <textarea
          ...
          className="rounded-md border border-input bg-background px-3 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-ring aria-[invalid=true]:border-destructive resize-y"
        />
      ) : (
        <input
          id={name}
