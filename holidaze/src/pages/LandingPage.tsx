        ...
        <div className="absolute inset-0 flex items-center justify-center px-4 lg:px-24">
          ...
          <div className="w-full max-w-3xl">
            <div className="text-center mb-6">
                         <span className="font-serif text-4xl font-bold tracking-tight text-primary"> Find your perfect venue <br/>
</span>
</div>
            <LandingSearch />
...
across the world and book the stay you've always wanted.        </p>
        <div className="mt-12 border-t border-gray-200"></div>
